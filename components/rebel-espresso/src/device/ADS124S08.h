...
enum ADS124S08_ref_t { ADS124S08_ref_INTERNAL, ADS124S08_ref_EXTERNAL };
 ...
 */
struct ADS124S08_data_t ADS124S08_conv(bool enable_chop, enum ADS124S08_ref_t ref, struct ADS124S08_adc_mux_t adc_mux,
                                       struct ADS124S08_idac_mux_t idac_mux, uint8_t idac_current, uint8_t pga_gain);
