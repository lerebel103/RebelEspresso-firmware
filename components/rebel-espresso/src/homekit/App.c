...
static const char* _get_serial() {
    uint8_t mac[6];
    esp_wifi_get_mac(ESP_IF_WIFI_STA, mac);
    static char accessory_id[32] = {0,};
...
void AppAccessoryServerStart(void) {
    accessory.serialNumber = _get_serial();
