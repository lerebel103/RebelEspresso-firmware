...
#define kIID_Switch                 ((uint64_t) 0x0030)
#define kIID_switchServiceSignature ((uint64_t) 0x0031)
#define kIID_SwitchName             ((uint64_t) 0x0032)
#define kIID_SwitchOn               ((uint64_t) 0x0033)
...
/**
 * The 'Service Signature' characteristic ofSwitch service.
 */
